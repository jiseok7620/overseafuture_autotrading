...
class ebestapi_o3103_1m_cls:
    # 쿼리 상태 초기화
    query_state = 0

    # 데이터 받으면 해당 이벤트로 이동
    def OnReceiveData(self, code):
        ebestapi_o3103_1m_cls.query_state = 1
...
class o3103_1m_cls:
    def exe_o3103_1m(self):
        # 쿼리 객체 생성 
        object_o3103 = win32com.client.DispatchWithEvents("XA_DataSet.XAQuery", ebestapi_o3103_1m_cls)
        
        # Res 파일 등록
        object_o3103.ResFileName = "C:\\eBEST\\xingAPI\\Res\\o3103.res"

        # 쿼리 상태 초기화 
        ebestapi_o3103_1m_cls.query_state = 0
        
        # InBlock에 값 설정
        object_o3103.SetFieldData("o3103InBlock", "shcode", 0, "HMHH22") # 조회 종목 코드(CME 거래소는 신청해야 가능)
        object_o3103.SetFieldData("o3103InBlock", "ncnt", 0, "1") # 조회 분 
        ...
        print('o3103_1m 10분 당 제한 건수 : ', count_limit)
        print('o3103_1m 10분 내 요청 횟수 : ', count_request)
        
        # 수신 대기
        while ebestapi_o3103_1m_cls.query_state == 0:
