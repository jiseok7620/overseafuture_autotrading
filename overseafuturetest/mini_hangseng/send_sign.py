        ...
        if info_1m_touch2.empty:
            ...
            for i in range(len(result_append_1m)):
                ...
                if invest_how == "매수" :
                    ...
                    goal_price = close_1m + (close_1m - stop_loss) # 청산가
                    ...
                    sendMessage = "최저선(신호) 일시/가격/구분 : " + minline_dd + " / " + minline_price + " / " + minline_gubun + \
                            ...
                            "\n손절가 / 청산가 : " + str(stop_loss) + " / " + str(goal_price)
                    ...
                    # 값 리턴하기
                    return '성공', invest_how, stop_loss, goal_price
                    
                # 매도진입시
                elif invest_how == "매도" :
                    stop_loss = inte_df_1m[ftouch_ind:stouch_ind+1]['고가'].max() # 손절가
                    goal_price = close_1m - (stop_loss - close_1m) # 청산가
